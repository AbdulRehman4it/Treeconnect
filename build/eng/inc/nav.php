...
<!-- <canvas id="dotsCanvas" class="absolute top-0 left-0 w-full h-full z-10 pointer-events-none"></canvas> -->
  ...
  <div class="flex justify-between items-center bg-[#3F6893] px-8 py-5 rounded-[40px] ">
    ...
    <div class="hidden lg:block">
      <ul class="flex xl:space-x-14 space-x-10">
        <li><a href="./index.php" class="text-[#D3D3D3] xl:text-lg text-base hover:text-white active">Home</a></li>
        ...
        <li class="relative group">
          ...
          <ul class="absolute left-0 pt-4 w-48 bg-[#3F6893] text-white rounded-lg shadow-lg hidden group-hover:block z-50">
            <li><a href="./services.php" class="block px-4 py-2 hover:bg-[#35597C] text-base">Business Creation & Launch</a></li>
            <li><a href="./services2.php" class="block px-4 py-2 hover:bg-[#35597C] text-base">Human Resources</a></li>
            <li><a href="./services3.php" class="block px-4 py-2 hover:bg-[#35597C] text-base">Admin & Back-Office</a></li>
            <li><a href="./services4.php" class="block px-4 py-2 hover:bg-[#35597C] text-base">IT and Cybersecurity</a></li>
            <li><a href="./services5.php" class="block px-4 py-2 hover:bg-[#35597C] text-base">Accounting & Finance</a></li>
      ...
      <div class="relative inline-block text-left">
        <div class="relative inline-block text-left top-1">
          <button onclick="toggleDropdown()" class="flex items-center">
            <img id="currentFlag" src="../assets/img/united-kingdom.png" class="w-6 h-6" alt="flag">
          ...
          <div id="dropdownMenu" class="hidden absolute mt-2 w-24 bg-[#3F6893] border border-[#3F6893] z-10">
            <ul class="py-1 text-sm text-gray-700 text-center">
              ...
              <li>
                <a href="../index.php" onclick="event.preventDefault(); setFlag('../assets/img/france.png', this.href)" class="block flex justify-center hover:text-white px-4 py-2 hover:bg-white">
  ...
  <div id="mobile-menu" class="absolute left-0 right-0 hidden mt-5 bg-[#3F6893] h-[550px] rounded-3xl px-6 py-5 z-40 transition-all duration-300 ease-in-out">
    <ul class="flex flex-col space-y-4 text-center">
      <li><a href="./index.php" class="text-white text-base hover:text-white active">Home</a></li>
      ...
      <li class="relative group">
        ...
        <ul id="mobileDropdown" class="hidden mt-2 space-y-2 absolute left-20 md:left-60 p-4 w-56 bg-[#3F6893] text-white rounded-lg shadow-lg group-hover:block z-50">
          <li><a href="./services.php" class="block px-4 py-2 hover:bg-[#35597C] text-sm">Business Creation & Launch</a></li>
          <li><a href="./services2.php" class="block px-4 py-2 hover:bg-[#35597C] text-sm">Human Resources</a></li>
          <li><a href="./services3.php" class="block px-4 py-2 hover:bg-[#35597C] text-sm">Admin & Back-Office</a></li>
          <li><a href="./services4.php" class="block px-4 py-2 hover:bg-[#35597C] text-sm">IT and Cybersecurity</a></li>
          <li><a href="./services5.php" class="block px-4 py-2 hover:bg-[#35597C] text-sm">Accounting & Finance</a></li>
      ...
      <li><a href="./login.php"><button class="text-white">Login</button></a></li>
       <li class="flex justify-center space-x-4 mt-4">
        ...
        <a href="../index.php" onclick="event.preventDefault(); setFlagMobile('../assets/img/france.png', this.href)">
